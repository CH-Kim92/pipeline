...
class requestData(models.Model):
    ...
    HouseData_id = models.ForeignKey(
        HouseData, on_delete=models.CASCADE, related_name='receivedHouse', null=True)
    ...
    fromHouse_id = models.ForeignKey(
        HouseData, on_delete=models.CASCADE, related_name='requestHouse', null=True)
